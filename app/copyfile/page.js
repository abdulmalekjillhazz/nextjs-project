  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
        ...
        <nav className="hidden md:block">
          {['Home', 'About', 'Works', 'Contact'].map((item) => (
            <a 
              ...
              className="ml-6 text-gray-700 hover:text-black font-medium transition-colors"
            >
              {item}
            </a>
          ))}
      ...
      <main className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 min-h-[80vh] items-center">
        ...
        <section 
          className="bg-yellow-400 rounded-[30px] overflow-hidden shadow-2xl hidden lg:block h-full relative"
